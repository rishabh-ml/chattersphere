...
export default function LandingCommunityCard({
  icon,
  name,
  members,
  description,
  color,
}: LandingCommunityCardProps) {
  ...
  return (
    ...
    >
      ...
      <button className={`text-sm font-medium hover:underline transition-colors`} style={{ color }}>
        Join Community →
      </button>
    </motion.div>
  );

 ...
 */
export async function getCommunities(options: CommunitiesQueryParams = {}): Promise<PaginatedCommunities> {
 ...
 */
export async function createCommunity(data: CommunityCreateInput): Promise<{ community: Community }> {
 ...
 * Update a community
 */
export async function updateCommunity(slug: string, data: CommunityUpdateInput): Promise<{ community: Community }> {
 ...
 * Join a community
 */
export async function joinCommunity(slug: string): Promise<{ success: boolean, isPending?: boolean }> {
  return ApiClient.post<{ success: boolean, isPending?: boolean }>(`/api/communities/${slug}/join`, {});
}
 ...
 * Update member role
 */
export async function updateMemberRole(slug: string, userId: string, role: string): Promise<{ success: boolean }> {
 ...
 */
export async function approveJoinRequest(slug: string, userId: string): Promise<{ success: boolean }> {
  return ApiClient.post<{ success: boolean }>(`/api/communities/${slug}/requests/${userId}/approve`, {});
}

/**
 * Reject a join request
 */
export async function rejectJoinRequest(slug: string, userId: string): Promise<{ success: boolean }> {
  return ApiClient.post<{ success: boolean }>(`/api/communities/${slug}/requests/${userId}/reject`, {});
}

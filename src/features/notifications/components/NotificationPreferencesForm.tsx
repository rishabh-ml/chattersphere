          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked: boolean) => handleToggleChange('allowPushNotifications', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                checked={formValues.allowEmailNotifications}                onCheckedChange={(checked: boolean) => handleToggleChange('allowEmailNotifications', checked)}
              />
            </div>

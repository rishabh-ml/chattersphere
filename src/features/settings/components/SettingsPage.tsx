...
export default function SettingsPage() {
  ...
  const handlePrivacyChange = (
    key: keyof NonNullable<typeof userData>["privacySettings"],
    value: boolean
  ) => {
    if (!userData) return;
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={userData?.name || ""}
                    onChange={(e) =>
                      setUserData((prev) => (prev ? { ...prev, name: e.target.value } : null))
                    }
                  />
                </div>
                <div className="space-y-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <Button variant="outline" onClick={() => (window.location.href = "/user/account")}>
                  Manage Email
                </Button>
              </div>
              ...
              <div>
                ...
                <Button variant="outline" onClick={() => (window.location.href = "/user/security")}>
                  Security Settings
                </Button>
              </div>
              ...
              <div>
                ...
                {userData && (
                  <DeleteAccountButton userId={userData.id} username={userData.username} />
                )}
              </div>
            </CardContent>
          </Card>

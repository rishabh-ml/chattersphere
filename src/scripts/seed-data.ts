...
async function createPosts(users: any[], communities: any[]) {
  ...
  const posts = [
    ...
    {
      author: admin._id,
      content: 'Welcome to the Tech Enthusiasts community! This is a place to discuss all things tech-related.',
      community: techCommunity._id,
      upvoteCount: 15,
      downvoteCount: 2,
      commentCount: 3,
    ...
    {
      author: alice._id,
      content: 'What do you think about the latest advancements in AI? I\'m particularly interested in large language models.',
      community: techCommunity._id,
      upvoteCount: 8,
      downvoteCount: 1,
      commentCount: 2,

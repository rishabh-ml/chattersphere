                ...
                {post.community && (
                  <>
                    ...
                    <Link
                      ...
                      onClick={(e) =>
                        post.community &&
                        navigation.goToCommunity(post.community.slug, post.community.id, e)
                      }
                    >
                      <Badge
                        variant="outline"
                        className="text-xs bg-blue-50 text-[#00AEEF] hover:bg-blue-100 border-blue-100"
                      >
                        {post.community.name}
                      </Badge>
                    </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href={routes.post(post.id)} onClick={(e) => navigation.goToPost(post.id, e)}>
              <Button
                variant="ghost"
                size="sm"
                className="h-8 gap-1 text-gray-500 hover:text-[#00AEEF] hover:bg-blue-50"
              >

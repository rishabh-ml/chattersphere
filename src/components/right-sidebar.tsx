            ...
            try {
                ...
                if (response.ok) {
                    ...
                    setSuggestedCommunities([
                        { id: '1', name: 'Photography', members: '12.4k', color: 'bg-purple-500', slug: 'photography' },
                ...
                >
                    <div className="relative inline-block mx-auto mb-2">
                        ...
                        {unreadMessageCount > 0 && (
                            <MessageNotificationBadge count={unreadMessageCount} className="absolute -top-2 -right-2" />
                        )}
                    </div>

          ...
          >
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                ChatterSphere is built by a passionate team of developers and designers who are
                dedicated to creating the best social platform for meaningful conversations and
                community building.
              </p>
            </div>
              ...
              <div className="md:flex items-center justify-between">
                <div className="mb-6 md:mb-0 md:mr-8">
                  ...
                  <p className="text-gray-600 mb-0 md:max-w-xl">
                    ...
                    building the future of social networking. Check out our open positions and join
                ...
                {[
                  {
                    ...
                    description:
                      "The idea for ChatterSphere was born out of a desire to create a more meaningful social platform focused on genuine conversations and community building.",
                  },
                  {
                    date: "February 2025",
                    title: "Design & Planning",
                    description:
                      "Our team spent months researching, planning, and designing the user experience to ensure ChatterSphere would be intuitive, accessible, and engaging.",
                  },
                  {
                    date: "March 2025",
                    title: "Development Begins",
                    description:
                      "With a solid plan in place, our development team started building the core functionality of ChatterSphere using modern web technologies.",
                  },
                  {
                    date: "May 2025",
                    title: "Beta Testing",
                    description:
                      "We invited a select group of users to test the platform, providing valuable feedback that helped us refine and improve the experience.",
                  },
                  {
                    date: "June 2025",
                    title: "Official Launch",
                    description:
                      "ChatterSphere officially launched to the public, marking the beginning of our journey to transform online social interactions.",
                  },
                  {
                    date: "Present",
                    title: "Continuous Improvement",
                    description:
                      "We're constantly working to enhance ChatterSphere with new features, improvements, and optimizations based on user feedback and emerging technologies.",
                  },
                ].map((item, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    ...
                    <div
                      ...
                      } top-0 h-5 w-5 rounded-full bg-[#38BDF8] border-4 border-white`}
                    ></div>

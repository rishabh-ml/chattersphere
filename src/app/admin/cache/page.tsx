...
export default function CacheDashboard() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          `Failed to fetch cache statistics: ${response.status} ${response.statusText}`
        );
      }
  ...
  const resetStats = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          `Failed to reset cache statistics: ${response.status} ${response.statusText}`
        );
      }
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{data.hitRate.toFixed(2)}%</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{data.stats.sets + data.stats.deletes}</div>
                <div className="text-sm text-muted-foreground">
            ...
            <TabsContent value="actions" className="mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  ...
                  <CardContent>
                    <p className="mb-4">
                      This will reset all cache statistics (hits, misses, etc.) to zero. The actual
                      cache data will not be affected.
                    </p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        <p className="mb-2">
                          Enter a pattern to invalidate cache keys. Use * as a wildcard.
                        </p>
                        <p className="text-sm text-muted-foreground mb-4">
                          Examples: post:*, user:123:*, *
                        </p>
                      </div>

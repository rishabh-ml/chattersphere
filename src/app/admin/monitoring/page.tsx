                      ...
                      <tbody>
                        {data.stats.slowestRoutes.map((route, index) => (
                          <tr key={index} className="border-b hover:bg-muted/50">
                            ...
                            <td className={`py-3 px-4 text-right font-mono ${getDurationColor(route.avgDuration)}`}>
                      ...
                      <tbody>
                        {data.metrics.map((metric, index) => (
                          <tr key={index} className="border-b hover:bg-muted/50">
                            ...
                            <td className="py-3 px-4 font-mono text-sm truncate max-w-xs">{metric.route}</td>
                            <td className="py-3 px-4 text-center">
                              <Badge className={getStatusColor(metric.status)}>
                                {metric.status}
                              </Badge>
                            </td>
                            <td className={`py-3 px-4 text-right font-mono ${getDurationColor(metric.duration)}`}>
                              {metric.duration}ms
                            </td>
                          </tr>
                        ))}

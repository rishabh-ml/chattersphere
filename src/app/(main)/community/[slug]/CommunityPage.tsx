    ...
    const handleMembershipRequest = async (
        ...
        try {
            const res = await fetch(
                `/api/communities/${community.id}/membership/${userId}`,
                {
                    method: "PATCH",
            ...
            setMembershipRequests((prev) =>
                prev.filter((req) => req.user.id !== userId)
            );
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <Avatar className="h-10 w-10">
                                                    {req.user.image ? (
                                                        <img src={req.user.image} alt={req.user.name} className="h-full w-full object-cover" />
                                                    ) : (

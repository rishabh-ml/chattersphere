      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6">
        ...
        >
          <TabsList className="grid grid-cols-3 w-full md:w-auto">
            <TabsTrigger value="feed" aria-selected={activeTab === "feed"}>Home Feed</TabsTrigger>
            <TabsTrigger value="popular" aria-selected={activeTab === "popular"}>Popular</TabsTrigger>

...
const mockUsers = [
  { id: 1, name: "Sarah Johnson", email: "sarah.j@example.com", role: "User", status: "Active", joinDate: "2023-05-15" },
  { id: 2, name: "Alex Chen", email: "alex.c@example.com", role: "Moderator", status: "Active", joinDate: "2023-04-22" },
  { id: 3, name: "Maya Patel", email: "maya.p@example.com", role: "Admin", status: "Active", joinDate: "2023-03-10" },
  { id: 4, name: "James Wilson", email: "james.w@example.com", role: "User", status: "Inactive", joinDate: "2023-06-05" },
  { id: 5, name: "Emma Thompson", email: "emma.t@example.com", role: "User", status: "Active", joinDate: "2023-05-30" }
]

const mockReports = [
  { id: 1, type: "Post", reportedBy: "User123", reason: "Inappropriate content", status: "Pending", date: "2023-06-10" },
  { id: 2, type: "Comment", reportedBy: "User456", reason: "Harassment", status: "Resolved", date: "2023-06-08" },
  { id: 3, type: "User", reportedBy: "User789", reason: "Spam", status: "Pending", date: "2023-06-09" }
]

const mockStats = [
  { label: "Total Users", value: "5,234", icon: <Users className="h-5 w-5" />, color: "bg-blue-500" },
  { label: "Active Today", value: "1,432", icon: <BarChart3 className="h-5 w-5" />, color: "bg-green-500" },
  { label: "New Posts", value: "287", icon: <Layers className="h-5 w-5" />, color: "bg-purple-500" },
  { label: "Reports", value: "12", icon: <Flag className="h-5 w-5" />, color: "bg-red-500" }
]
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-4 md:w-fit">
          <TabsTrigger value="overview" aria-selected={activeTab === "overview"}>Overview</TabsTrigger>
          <TabsTrigger value="users" aria-selected={activeTab === "users"}>Users</TabsTrigger>
          <TabsTrigger value="reports" aria-selected={activeTab === "reports"}>Reports</TabsTrigger>
          <TabsTrigger value="settings" aria-selected={activeTab === "settings"}>Settings</TabsTrigger>
        </TabsList>
      </Tabs>
                ...
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    <div className="flex items-center gap-1">
                      Name
                      <button onClick={toggleSortDirection} className="text-gray-400 hover:text-gray-600">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="p-4 rounded-lg bg-gray-50 border border-gray-200">
                <p className="text-sm text-gray-600 mb-4">Manage role-based permissions and access controls</p>
                <Button variant="outline" size="sm">
                  Manage Permissions
                </Button>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="p-4 rounded-lg bg-gray-50 border border-gray-200">
                <p className="text-sm text-gray-600 mb-4">Configure automated content filters and moderation rules</p>
                <Button variant="outline" size="sm">

        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 mb-12 max-w-2xl">
              Have questions, feedback, or need assistance? We&#39;re here to help! Fill out the
              form below or use one of our contact methods to get in touch with our team.
            </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    answer:
                      "Yes, you can delete your account from your account settings. Please note that this action is permanent and all your data will be removed from our platform.",
                  },
                  {
                    question: "How do I report inappropriate content?",
                    answer:
                      "You can report inappropriate content by clicking the 'Report' button next to any post or comment. Our moderation team will review the report and take appropriate action.",
                  },
                  {
                    question: "Is ChatterSphere available on mobile devices?",
                    answer:
                      "Yes, ChatterSphere is available as a web application that works on all modern browsers, including mobile browsers. We're also working on dedicated mobile apps for iOS and Android.",
                  },
                ].map((faq, index) => (
                  <motion.div
                    key={index}

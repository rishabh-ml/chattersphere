          ...
          >
            ...
            <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
              <section>
                ...
                <p>
                  This Cookie Policy explains how ChatterSphere (&#34;we&#34;, &#34;us&#34;, or
                  &#34;our&#34;) uses cookies and similar technologies to recognize you when you
                  visit our platform. It explains what these technologies are and why we use them,
              ...
              <section>
                ...
                <p>
                  Cookies set by the website owner (in this case, ChatterSphere) are called
              ...
              <section>
                ...
                <p>
                  ...
                  experience on our platform. Third parties serve cookies through our platform for
                  advertising, analytics, and other purposes.
                </p>
                <p>
                  The specific types of first and third-party cookies served through our platform
                ...
                <p>
                  ...
                  through our platform and to use some of its features, such as access to secure
                  areas. Because these cookies are strictly necessary to deliver the platform, you
                  cannot refuse them without impacting how our platform functions.
                </p>
                ...
                <p>
                  ...
                  understand how our platform is being used or how effective our marketing campaigns
                  are, or to help us customize our platform for you.
                </p>
                ...
                <p>
                  ...
                  interesting on our platform through third-party social networking and other
              ...
              <section>
                ...
                <p>
                  ...
                  the cookie banner on our platform.
                </p>
                <p>
                  You can also set or amend your web browser controls to accept or refuse cookies.
                  If you choose to reject cookies, you may still use our platform though your access
                  to some functionality and areas may be restricted. As the means by which you can
              ...
              <section>
                ...
                <p>Below is a detailed list of the cookies we use on our platform:</p>
                  ...
                  <table className="min-w-full border border-gray-200 mt-4">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-700 border-b">
                          Stores your preferences settings
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700 border-b">
                          1 year
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-700 border-b">
                          Used to track anonymous analytics data
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700 border-b">
                          2 years
                        </td>

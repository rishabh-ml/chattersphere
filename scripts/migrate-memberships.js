...
const migrateMemberships = async () => {
  ...
  for (const community of communities) {
    ...
    try {
      ...
      console.error(`Error creating membership for creator ${community.creator} in community ${community._id}:`, error);
    }
    ...
    for (const userId of community.moderators) {
      ...
      try {
        ...
        console.error(`Error creating membership for moderator ${userId} in community ${community._id}:`, error);
      }
    }
    ...
    for (const userId of community.members) {
      ...
      try {
        ...
        console.error(`Error creating membership for member ${userId} in community ${community._id}:`, error);
      }
    }
  }
